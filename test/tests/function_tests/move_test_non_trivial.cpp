...
BOOST_AUTO_TEST_SUITE(static_function_move_non_trivial_tests)

BOOST_AUTO_TEST_CASE_TEMPLATE(move_test_non_trivial, policy, fixtures::test_function_non_trivial_nullable_rebindable_policies)
{
